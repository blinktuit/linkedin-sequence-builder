              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {stepCategories.automatic.map((step, idx) => (
                  <button
                    ...
                    className="relative flex flex-col items-start gap-1.5 p-3 border border-border rounded-lg hover:bg-muted/50 hover:border-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-left"
                  >
                    {step.warning && (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {stepCategories.other.map((step, idx) => (
                  <button
                    ...
                    className="flex flex-col items-start gap-1.5 p-3 border border-border rounded-lg hover:bg-muted/50 hover:border-primary transition-colors text-left"
                  >
                    <div className="text-lg">{step.icon}</div>
                    <div className="flex-1">
                      <div className="font-medium text-sm">{step.label}</div>
